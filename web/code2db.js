    ...
    if (fileNames !== undefined) {
        for (const fileName of fileNames) {
            ...
            if (nameSplit.length !== 3) {
                ...
                // const qType = nameSplit[2];
                // if (db[qType] === undefined) {
                //   db[qType] = [];
                //   db.allQuestionTypes.push(qType);
                // }
                // db.questionType.push(qType);
                
                // const ns2 = nameSplit[3];
                const ns2 = nameSplit[2];
                if (db[ns2] === undefined) {
                    db[ns2] = []
        ...
        // for (let ct of db.allQuestionTypes) {
        //   db[ct].sort((a, b) => a[1] - b[1])
        // }
